...
using TransactionManagementAPI.Extensions;
...
public class TransactionController : ControllerBase
{
    ...
    [HttpGet("ByMinimumAmount/{minimumAmount}")]
    public IActionResult GetTransactionsWithMinimumAmount(decimal minimumAmount)
    {
        var filteredTransactions = _transactions.FilterByMinimumAmount(minimumAmount);
